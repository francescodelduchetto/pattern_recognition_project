...
if __name__ == '__main__':
    ...
    def encode(input_strokes):
      ...
      draw_strokes(to_normal_strokes(np.array(strokes)), svg_filename='svg/encode_sample.svg')
    ...
    #z = encode(stroke)
    #
    #stroke_decoded = decode(z_input=z, temperature=0.0001)
    #stroke_decoded = decode(z_input=z, temperature=0.0001, svg_filename='sketch_rnn/svg/decode2_sample.svg')
    
    #draw_strokes(stroke_decoded, svg_filename="sketch_rnn/svg/sample_dec.svg")
